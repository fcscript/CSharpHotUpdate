...
public class GameObject_wrap
{
    ...
    public static void Register()
    {
        ...
        FCLibHelper.fc_register_class_func(nClassName,"GetComponent",GetComponent1_wrap);
        ...
        FCLibHelper.fc_register_class_func(nClassName,"AddComponent",AddComponent1_wrap);
        ...
        try
        {
            ...
            switch(arg0)
            {
                case "SkinnedMeshRenderer":
                {
                    ...
                    nRetPtr = FCGetObj.PushNewObj<SkinnedMeshRenderer>(ret_obj);
                }
                break;
                default:
                break;
            }
            FCLibHelper.fc_push_intptr(nRetPtr);
        }
        catch(Exception e)
        {
            Debug.LogException(e);
